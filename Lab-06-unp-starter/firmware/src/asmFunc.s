...
nameStr: .asciz "Ben Phan: I'm submitting this code in the blind since I left my data cable somewhere."  
...
.endif
	...
	* Use it to test the C test code */
	...
	/* A */
	asr r1, r1, 16		/*  sign extension(MSB) + shift to the right to remove B */
	ldr r4, =a_value
	str r1, [r4]

	/* B */
	lsl r2, r2, 16		/*  shift left to remove A */
	asr r2, r2, 16		/*  sgin extension(MSB) */
	ldr r4, =b_value
	str r2, [r4]
